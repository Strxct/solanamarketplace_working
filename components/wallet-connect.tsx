  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" className="border-primary/20 hover:bg-primary/10">
          <div className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline">{shortenAddress(wallet.publicKey?.toString())}</span>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem onClick={copyAddress} className="cursor-pointer flex justify-between">
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem onClick={openExplorer} className="cursor-pointer flex items-center gap-2">
